...
PUBLIC_CASE_FILES = [
    ROOT / "examples/vggt-human-prior-survey/public_case_study/case_study_draft.md",
    ROOT / "examples/vggt-human-prior-survey/public_case_study/redaction_report.md",
    ROOT / "examples/vggt-human-prior-survey/public_case_study/claim_safety_report.md",
...
def test_vggt_public_case_study_files_are_public_safe() -> None:
    ...
    assert "main TulingResearch Plus repository remains flagship" in combined
