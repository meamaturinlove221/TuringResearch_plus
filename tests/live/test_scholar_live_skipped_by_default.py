...
@pytest.mark.live
def test_scholar_live_is_skipped_by_default(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    pytest.fail("Scholar live test should be skipped without explicit live opt-in")
