---
name: turingresearch-race-feature-capsule-factory
description: Use when creating or validating P0/P1 Feature Capsule skeletons.
---

# TuringResearch Plus Skill: turingresearch-race-feature-capsule-factory
...
- User request naming `turingresearch-race-feature-capsule-factory` or the matching TuringResearch Plus lane.
...
- `src/turing_research_plus/race/feature_capsule.py`
