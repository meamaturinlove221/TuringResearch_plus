---
name: turingresearch-yogsoth-module-audit
description: Use when mapping public Yogsoth AI reference patterns into TuringResearch Plus module plans.
---

# TuringResearch Plus Skill: turingresearch-yogsoth-module-audit
...
- User request naming `turingresearch-yogsoth-module-audit` or the matching TuringResearch Plus lane.
