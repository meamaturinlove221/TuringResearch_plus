---
name: turingresearch-race-priority-elevator
description: Use when maintaining P0/P1/P2/P3 priority scoring and feature-capsule recommendations.
---

# TuringResearch Plus Skill: turingresearch-race-priority-elevator
...
- User request naming `turingresearch-race-priority-elevator` or the matching TuringResearch Plus lane.
...
- `src/turing_research_plus/race/priority_elevator.py`
