---
name: turingresearch-paper-sop-graph-generator
description: Use when generating TuringResearch Plus SOP graph skeletons or Mermaid workflow diagrams.
---

# TuringResearch Plus Skill: turingresearch-paper-sop-graph-generator
...
- User request naming `turingresearch-paper-sop-graph-generator` or the matching TuringResearch Plus lane.
