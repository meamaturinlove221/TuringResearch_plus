---
name: turingresearch-race-architecture-box-builder
description: Use when mapping TuringResearch Plus Race Mode findings into architecture boxes.
---

# TuringResearch Plus Skill: turingresearch-race-architecture-box-builder
...
- User request naming `turingresearch-race-architecture-box-builder` or the matching TuringResearch Plus lane.
...
- `src/turing_research_plus/race/architecture_box.py`
