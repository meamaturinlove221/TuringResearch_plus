---
name: turingresearch-paper-figure-asset-pipeline
description: Use when defining TuringResearch Plus paper figure and asset pipeline boundaries.
---

# TuringResearch Plus Skill: turingresearch-paper-figure-asset-pipeline
...
- User request naming `turingresearch-paper-figure-asset-pipeline` or the matching TuringResearch Plus lane.
...
- `src/turing_research_plus/paper/figure_registry.py`
- `src/turing_research_plus/paper/caption_generator.py`
- `paper/figures/`
- `paper/captions/`
- `paper/tables/`
