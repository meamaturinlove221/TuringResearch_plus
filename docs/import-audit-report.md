# TulingResearch Plus Import Audit Report
...
- Local import roots detected: `tuling_research`, `tuling_research_plus`.

## Required Import Boundaries

- Core package imports must use `tuling_research`.
- Plus package imports must use `tuling_research_plus`.
...
- Local package imports are limited to `tuling_research` and `tuling_research_plus`.
