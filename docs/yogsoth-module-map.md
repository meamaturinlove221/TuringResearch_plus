# TuringResearch Plus Yogsoth Module Map

Round 4 audits public `yogsoth-ai` repositories as architecture references for TuringResearch Plus. This document maps reusable public ideas into TuringResearch Plus Python modules, contracts, future skills, and lanes. It does not copy source code, prompts, skill files, schemas, or project naming.
...
## Target TuringResearch Plus Modules
...
5. Do not transplant: Project philosophy branding, markdown skill files, npm/MCP package layout, external project names, autonomous behavior without TuringResearch gates.
6. Python equivalent: `src/turing_research_plus/context/`, `src/turing_research_plus/subtask/`, and campaign models already started under `src/turing_research_plus/campaign/`.
...
6. Python equivalent: `src/turing_research_plus/survey/` plus Core `core.paper_content`, `core.paper_reference`, `pdf.markdown_content`.
...
6. Python equivalent: `src/turing_research_plus/survey/`.
...
6. Python equivalent: Core `core.web_content`; future Plus source hygiene under `src/turing_research_plus/survey/` and `src/turing_research_plus/context/`.
...
6. Python equivalent: `src/turing_research_plus/semantic_graph/`.
...
6. Python equivalent: `src/turing_research_plus/survey/`, `src/turing_research_plus/semantic_graph/`, `src/turing_research_plus/context/`.
...
6. Python equivalent: `src/turing_research_plus/north_star/`.
...
6. Python equivalent: `src/turing_research_plus/insight/`.
...
6. Python equivalent: `src/turing_research_plus/hypothesis/`.
...
6. Python equivalent: `src/turing_research_plus/ideation/`.
...
6. Python equivalent: `src/turing_research_plus/convergence/`.
...
6. Python equivalent: `src/turing_research_plus/stress/`.
...
6. Python equivalent: `src/turing_research_plus/experiment/`.
...
6. Python equivalent: `src/turing_research_plus/context/`.
...
6. Python equivalent: `src/turing_research_plus/subtask/`.
...
5. Do not transplant: TypeScript implementation, package name, direct file schema without TuringResearch contracts.
6. Python equivalent: `src/turing_research_plus/vault/`.
...
6. Python equivalent: `src/turing_research_plus/semantic_graph/` and `src/turing_research_plus/vault/`.
...
TuringResearch Plus should reuse architecture patterns, workflow decomposition, contracts, quality gates, evidence rules, and data-model ideas. It must not copy incompatible code, prompt text, repository structure, package naming, or external MCP runtime assumptions.
