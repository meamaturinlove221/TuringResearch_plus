...
Use this skill when a task is about `plugin_architecture` planning, contract alignment, test
...
- The user asks for `Plugin Architecture` scope, docs, contracts, tests, or review.
