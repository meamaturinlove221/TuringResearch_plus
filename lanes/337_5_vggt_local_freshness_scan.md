...
Refresh TulingResearch Plus local VGGT scan metadata for deciding whether `split_ready/turingresearch-vggt-case` needs an update, without running VGGT, modifying `D:/vggt`, copying private artifacts, or producing fake results.
