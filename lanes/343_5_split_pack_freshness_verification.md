...
| `split_manual/turingresearch-vggt-case/` | observed in cloud baseline, marker created |
| `docs/vggt-case-study-refresh-v1.5.md` | observed |
| `docs/vggt-case-repo-manual-pack-report.md` | observed |
...
- `split_manual/turingresearch-vggt-case`: fresh manual draft; still requires human review before external repo creation or push.
- External child repository: not created and not pushed.
- Main TuringResearch Plus repository: remains flagship.
