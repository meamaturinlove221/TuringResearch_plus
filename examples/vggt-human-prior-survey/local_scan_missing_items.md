...
| Item | Status | Notes |
| --- | --- | --- |
| `D:/TulingResearch_plus/examples/vggt-human-prior-survey/local_project_links.yaml` | missing | Missing private local_project_links.yaml; using the example config only to generate dry-run guidance. |
