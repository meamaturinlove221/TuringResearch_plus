...
| Exclude unsupported claims | observed | Claims are marked `observed`, `local-observed`, `requires-human-review`, or guarded. |
...
- requires-human-review: SparseConv3D success, advisor approval, and promotion remain unclaimed.
