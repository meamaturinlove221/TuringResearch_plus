"""16-Box Architecture Builder for TulingResearch Plus."""
...
def build_architecture_boxes() -> ArchitectureBoxBuildResult:
    """Build the default TulingResearch Plus 16-box architecture."""
...
def _default_boxes() -> list[ArchitectureBox]:
    return [
        ArchitectureBox(
            ...
            owner_skill="tulingresearch-race-idea-radar",
            public_tools=["race.idea_extract"],
            internal_modules=["src/tuling_research_plus/race/idea_radar.py"],
        ...
        ArchitectureBox(
            ...
            owner_skill="tulingresearch-race-priority-elevator",
            public_tools=["race.priority_score"],
            internal_modules=["src/tuling_research_plus/race/priority_elevator.py"],
        ...
        ArchitectureBox(
            ...
            owner_skill="tulingresearch-race-source-hygiene",
            public_tools=["race.source_hygiene_check"],
            internal_modules=["src/tuling_research_plus/race/source_hygiene.py"],
            input_artifacts=["SourceMaterial"],
        ...
        ArchitectureBox(
            ...
            owner_skill="tulingresearch-race-upstream-watch",
            public_tools=["race.upstream_watch"],
            internal_modules=["src/tuling_research_plus/race/upstream_watch.py"],
        ...
        ArchitectureBox(
            ...
            owner_skill="tulingresearch-race-feature-capsule-factory",
            public_tools=["race.feature_capsule_create"],
            internal_modules=["src/tuling_research_plus/race/feature_capsule.py"],
        ...
        ArchitectureBox(
            ...
            owner_skill="tulingresearch-paper-sop-graph-generator",
        ...
        ArchitectureBox(
            ...
            owner_skill="tulingresearch-core-reproduction",
            public_tools=["core.paper_content", "core.paper_searching", "core.paper_fetching"],
            internal_modules=["src/tuling_research/scholar/"],
        ...
        ArchitectureBox(
            ...
            internal_modules=["src/tuling_research/web/"],
        ...
        ArchitectureBox(
            ...
            owner_skill="tulingresearch-pdf-markdown-core",
            public_tools=["pdf.inspect", "pdf.to_markdown", "pdf.markdown_content"],
            internal_modules=["src/tuling_research/pdf/"],
        ...
        ArchitectureBox(
            ...
            owner_skill="tulingresearch-fusion-semantic-graph",
            public_tools=["graph.paper_lookup", "graph.citation_graph_expand"],
            internal_modules=["src/tuling_research_plus/semantic_graph/"],
        ...
        ArchitectureBox(
            ...
            owner_skill="tulingresearch-fusion-literature-survey",
            public_tools=["research.survey_plan", "research.survey_run"],
            internal_modules=["src/tuling_research_plus/survey/"],
        ...
        ArchitectureBox(
            ...
            owner_skill="tulingresearch-fusion-wiki-vault",
            public_tools=["vault.search", "vault.ingest_source", "vault.query_graph"],
            internal_modules=["src/tuling_research_plus/vault/"],
        ...
        ArchitectureBox(
            ...
            owner_skill="tulingresearch-fusion-context-management",
            public_tools=["context.init", "context.checkpoint", "context.recover"],
            internal_modules=["src/tuling_research_plus/context/"],
            input_artifacts=["ResearchArtifact"],
        ...
        ArchitectureBox(
            ...
            owner_skill="tulingresearch-fusion-hypothesis-formation",
        ...
        ArchitectureBox(
            ...
            owner_skill="tulingresearch-fusion-convergence",
            public_tools=[
        ...
        ArchitectureBox(
            ...
            owner_skill="tulingresearch-paper-writing-pipeline",
            public_tools=[
                "paper.article_block_update",
                "paper.figure_register",
                "paper.draft_generate",
            ],
            internal_modules=["src/tuling_research_plus/paper/"],
